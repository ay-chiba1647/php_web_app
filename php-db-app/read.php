<?php
 ...
 try {
     ...
     if ($order === 'desc') {
      $sql_select = 'SELECT * FROM producuts WHERE product_name LIKE :keyword ORDER BY updated_at DESC';
     } else {
      $sql_select = 'SELECT * FROM producuts WHERE product_name LIKE :keyword ORDER BY updated_at ASC';
     }
